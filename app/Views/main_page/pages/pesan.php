...
<body id="page-top">
                            ...
                            <div class="card p-3">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="btn btn-primary text-uppercase" data-toggle="modal" data-target="#modalPaketKost">Pilih Paket</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalPaketKost" tabindex="-1" aria-labelledby="modalPaketKostLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
        <!-- <div class="modal-header">
            <h5 class="modal-title" id="modalPaketKostLabel">Under Maintenance!</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div> -->
        <div class="modal-body">
            <img src="<?php echo base_url('/main_page/img/develop.png') ?>" width="100%" alt="">
            <div class="text-center">
                <h3>Sorry!</h3> feature is still under development
            </div>
        </div>
